 ...
 *
 *  2006-12-29: Modified to work for antlr3 by J�rgen Pfundt
 ...
 *  2010-05-06: Adapt the antrl3 task for ant to Antlr 3.2.
 *              Backward compatibility is broken.
 *  2010-05-07: Support the option maxinlinedfastates.
 *  2010-12-30: Added support of the verbose and make option, enabled trace
 *              again.  Deprecated conversion time out.
 */
...
public class ANTLR3 extends Task {
     ...
     */
    private String maxinlinedfastates;
     ...
     */
    public void setOutputdirectory(final File outputDirectoryFile) {
     ...
     */
    public void setLibdirectory(final File libDirectoryFile) {
     ...
     */
    public void setMessageformat(final String name) {
     ...
     * @deprecated
     */
    public void setGlib(final File superGrammarFile) {
     ...
     */
    public void setPrint(final boolean enable) {
        this.print = enable;
    }
     ...
     */
    public void setProfile(final boolean enable) {
        this.profile = enable;
    }
     ...
     */
    public void setNfa(final boolean enable) {
        this.nfa = enable;
    }
     ...
     * Sets a flag to enable nfa generation
     */
    public void setDfa(final boolean enable) {
        this.dfa = enable;
    }
     ...
     */
    public void setMake(final boolean enable) {
        this.make = enable;
    }
     ...
     * @param enable
     */
    public void setMultithreaded(final boolean enable) {
     ...
     * @param enable
     */
    public void setNoMergeStopStates(final boolean enable) {
        noMergeStopStates = enable;
    }
     ...
     * @param enable
     */
    public void setNocollapse(final boolean enable) {
        nocollapse = enable;
    }
     ...
     * @param enable
     */
    public void setNoprune(final boolean enable) {
        noprune = enable;
    }
     ...
     * @param enable
     */
    public void setDbgST(final boolean enable) {
        dbgST = enable;
    }
     ...
     * @deprecated 
     */
    public void setConversiontimeout(final String conversiontimeoutString) {
        log("Setting conversiontimeout to: " + conversiontimeoutString, Project.MSG_VERBOSE);
        try {
            int timeout = Integer.parseInt(conversiontimeoutString);
            this.conversiontimeout = conversiontimeoutString;
        } catch (NumberFormatException e) {
            log("Option -Xconversiontimeout ignored due to illegal value: '" + conversiontimeoutString + "'", Project.MSG_ERR);
        }
    }

    /**
     * override the default limit before table used rather han inlining with -Xmaxinlinedfastates m
     * @param maxinlinedfastatesString
     */
    public void setMaxInlineDFAStates(final String maxinlinedfastatesString) {
        log("Setting maxinlinedfastates to: " + maxinlinedfastatesString, Project.MSG_VERBOSE);
        try {
            int timeout = Integer.parseInt(maxinlinedfastatesString);
            this.maxinlinedfastates = maxinlinedfastatesString;
        } catch (NumberFormatException e) {
            log("Option -Xmaxinlinedfastates ignored due to illegal value: '" + maxinlinedfastatesString + "'", Project.MSG_ERR);
        }
    }
     ...
     */
    public void setGrammartree(final boolean enable) {
        grammarTree = enable;
    }
     ...
     * @deprecated
     */
    public void setDepend(final boolean s) {
        this.depend = s;
    }
     ...
     * @deprecated
     */
    public void setDiagnostic(final boolean enable) {
        diagnostic = enable;
    }
     ...
     */
    public void setTrace(final boolean enable) {
        trace = enable;
    }
     ...
     * @deprecated
     */
    public void setTraceParser(final boolean enable) {
        traceParser = enable;
    }
     ...
     * @deprecated
     */
    public void setTraceLexer(final boolean enable) {
        traceLexer = enable;
    }
    ...
    public void init() throws BuildException {
        ...
        /* Get value for key "ANTLR_LIBDIR" which should hopefully point to
         * the directory where the current version of antlr3 is installed */
        String antlrLibDir = variables.get("ANTLR_LIBDIR");
        if (antlrLibDir != null) {
            log("Looking for ANLTR3 libraries via ANTLR_LIBDIR "+antlrLibDir, Project.MSG_VERBOSE);
            addAntlrJarsToClasspath(antlrLibDir, "ANTLR_LIBDIR");
        } else {
            log("Environment variable ANTLR_LIBDIR not defined", Project.MSG_VERBOSE);
        }
        /* Get value for key "ANTLR_HOME" which should hopefully point to
         * the directory where the current version of antlr3 is installed.
         * First look in ANTLR_HOME/lib.If no ANTLR3 libraries could be 
         * found scan the ANTLR_HOME directory for ANTLR3 libraries.
         */

        String antlrHome = variables.get("ANTLR_HOME");
        if (antlrHome != null) {
            /* Environment variable ANTLR_HOME has been defined.
             * Now add all antlr*.jar to the classpath */
            log("Looking for ANLTR3 libraries via ANTLR_HOME in "+antlrHome+"/lib", Project.MSG_VERBOSE);
            if (!addAntlrJarsToClasspath(antlrHome + "/lib", "ANTLR_HOME")) {
                /* for backwards compatibility only */
                log("No ANLTR libraries found in "+antlrHome + "/lib", Project.MSG_VERBOSE);
                log("Looking for ANLTR3 libraries via ANTLR_HOME in "+antlrHome, Project.MSG_VERBOSE);
                if ( !addAntlrJarsToClasspath(antlrHome, "ANTLR_HOME") ) {
                    log("No ANLTR libraries found in "+antlrHome, Project.MSG_VERBOSE);
                }
            }
            else {
                log("ANLTR libraries found in "+antlrHome + "/lib", Project.MSG_VERBOSE);
            }
        } else {
            log("Environment variable ANTLR_HOME not defined", Project.MSG_VERBOSE);
        }

        addClasspathEntry("/antlr/ANTLRGrammarParseBehavior.class", "AntLR2");
        addClasspathEntry("/org/antlr/Tool.class", "AntLR3");
    ...
    protected void addClasspathEntry(String resource, String msg) {
        ...
        log("Inquire for resource " + resource + " via classpath: ", Project.MSG_VERBOSE);
        File f = LoaderUtils.getResourceSource(getClass().getClassLoader(), resource);

        if (f != null) {
            log("Found library " + msg + " via classpath: " + f.getAbsolutePath(), Project.MSG_VERBOSE);
    ...
    /**
     * If the environment variable ANTLR_LIBDIR or ANTLR_HOME is defined and points
     ...
     * new releases. Just let ANTLR_LIBDIR or ANTLR_HOME point to the new installation
     * directory.
     */
    private boolean addAntlrJarsToClasspath(String antlrLibDir, String envVariable) {
        /* The antlr-runtime-*.jar pattern is already covered by antlr-*.jar,
         * but it does not hurt to mention it. */
        String[] includes = {"antlr-*.jar", "stringtemplate-*.jar", "antlr-runtime-*.jar"};
        String[] files = null;
        ...
        try {
            ...
            log("Problem with directory " + antlrLibDir + " " + e.getMessage(), Project.MSG_VERBOSE);
        }
        ...
        for (String file : files) {
            ...
            log("Found via " + envVariable + ": " + f.getAbsolutePath(), Project.MSG_VERBOSE);
            createClasspath().setLocation(f);
            log("Added " + f.getAbsolutePath() + " to classpath", Project.MSG_VERBOSE);
        }
    ...
    private void populateAttributes() {
        ...
        if (diagnostic) {
            log("Option 'diagnostic' is not supported by ANTLR v3. Option ignored!", Project.MSG_WARN);
        }
        if (depend) {
            if (!make) {
                log("Option 'depend' is implicitely used by ANTLR v3. Option can safely be omitted!", Project.MSG_WARN);
            }
        }
        if (trace) {
        ...
        if (make) {
            commandline.createArgument().setValue("-make");
        }
        if (multiThreaded) {
            commandline.createArgument().setValue("-Xmultithreaded");
        }
        if (noMergeStopStates) {
            commandline.createArgument().setValue("-Xnomergestopstates");
        }
        if (nocollapse) {
        ...
        if (maxinlinedfastates != null) {
            commandline.createArgument().setValue("-Xmaxinlinedfastates");
            commandline.createArgument().setValue(maxinlinedfastates);
        }
        if (grammarTree) {
    ...
    private boolean dependencyCheck() throws BuildException {
        ...
        if (err != 0) {
            if (f.exists()) {
                if (!f.delete()) {
                    log("Deletion of file " + f.getName() + " failed!", Project.MSG_ERR);
                }
            }
        ...
        try {
            ...
            try {
                ...
                throw new BuildException("Could not close file\'" + f.toString() + "\'." + ex);
            }
            if (f.exists()) {
                if (!f.delete()) {
                    log("Deletion of file " + f.getName() + " failed!", Project.MSG_ERR);
            ...
            try {
                ...
                throw new BuildException("Could not open \'" + f.toString() + "\' for reading." + ex);
            }
        }
        ...
        try {
            while ((s = in.readLine()) != null) {
                ...
                if (to >= 0) {
                    a = new StringBuffer(s.substring(0, to).trim());
                    File lhs = new File(a.toString());
                    ...
                    File aFile = new File(a.toString());
                    ...
                    for (String name : names) {
                        ...
                        if (fileUtils.isUpToDate(aFile, bFile, 0L)) {
